...
CREATE TABLE `weather_data` (
  ...
  `weather_location` varchar(100) DEFAULT NULL,
  `temperature` int NOT NULL,
  `humidity` int NOT NULL,
  `weather_date` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
-- Dump completed on 2023-03-10 10:42:36
